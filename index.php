...
<body onload="setl()"
    ...
    <div style="display: none; background-image: url('./images/webassets/cover.jpg'); background-size: cover; background-position: center; height: 100%;" id="mainbody">
    
        <div class="w3-bar topbar w3-top" style="background-color: transparent;">
            <a class="w3-bar-item logo">Kisumu</a>
            <div class="w3-right">
                <a class="w3-bar-item w3-text-white w3-hide-small" href="./userdetails.php"><i class="fa fa-user">&nbsp;</i>
            ...
            <div class="w3-padding mainnav w3-hide-small" id="mainnav"
                style=" position: sticky; background-color: transparent;">
                <a href="#" class="w3-bar-item" style="margin-left: 90px;"><i class="fa fa-home">&nbsp;</i>Home</a>
        ...
        <div class="w3-modal" id="mobilemainnav" style="background-color: rgba(0, 0, 0, 0.1);">
            <div class="w3-modal-content w3-round-xlarge">
                <div class="w3-container mobmainnav" id="mobmainnav">
                    ...
                    <a href="#" class="w3-bar-item">About Us</a>
                    <a href="./products.php" class="w3-bar-item">Properties</a>
                    <a href="./userdetails.php" class="w3-bar-item">My Account</a>
        ...
        <div class="w3-row-padding">
            <div class="slide1 w3-center">
                <br><br>
                <h1 class="w3-text-white"><b>Kisumu County <span class="w3-text-blue"> Homes</span></b></h1>
                <div class="wallpaper-desc">
                    <p class="w3-text-white">Tired of walking and straining all day looking for a place to stay in? Be
                        assured you are in the right place</p>
                    <button
                        class="w3-button w3-blue w3-round">Get
                        Started</button>
                </div>
            </div>
        </div>
            ...
            <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round">
                <div class="w3-row login">
                    <form class="w3-col w3-padding l8" id="frmlogin">
                        ...
                        <input type="checkbox" name="remember_me" id="remember_me" class=""> Remember Me <a href=""
                            class="w3-right">Forgot Password</a>
                        <br><br>
                            ...
                            <form id="usersignup">
                                ...
                                <div class="w3-col w3-padding m12">
                                    register As&nbsp; <input type="radio" name="usertype"
                                        value="owner">&nbsp;owner&nbsp;&nbsp; <input type="radio" name="usertype"
                                        value="broker">&nbsp;Broker&nbsp;&nbsp; <input type="radio" name="usertype"
